...
// Type: Nintenlord.Event_Assembler.Core.Code.Preprocessors.BuiltInMacros.CurrentLine
...
{
  internal class CurrentLine : IMacro, IEquatable<IMacro>
  {
    ...
    {
      return this.Stream.LineNumber.ToString();
    }
