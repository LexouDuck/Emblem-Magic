...
namespace KirbyMagic
{
    public partial class App : Form, IApp
    {
        ...
        public App(String software_name)
        {
            ...
            this.AppVersion = System.Reflection.Assembly.GetEntryAssembly().GetName().Version;
        ...
        {
            this.Core_OpenEditor(new EnemyEditor());
        }
