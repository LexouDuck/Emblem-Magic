...
{
    public class KAM : Game
    {
        public KAM(GameVersion version, bool clean, bool expanded) : base(version, clean, expanded) { }
        
        public static string GameID(GameVersion version)
        {
            switch (version)
            {
                case GameVersion.JAP: return "AGB KIRBY AMB8KJ01";
                case GameVersion.USA: return "AGB KIRBY AMB8KE01";
                case GameVersion.EUR: return "AGB KIRBY AMB8KP01";
        ...
        public static uint Checksum(GameVersion version)
        {
            switch (version)
            {
                case GameVersion.JAP: return 0x683D772C;
                case GameVersion.USA: return 0x9F2A3048;
                case GameVersion.EUR: return 0x4F07C618;
                default: throw new Exception("Invalid game version.");
            }
        }
