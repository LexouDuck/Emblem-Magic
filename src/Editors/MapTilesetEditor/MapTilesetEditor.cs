...
namespace EmblemMagic.Editors
{
    public partial class MapTilesetEditor : Editor
    {
        ...
        void Core_LoadTerrain()
        {
            ...
            {
                Program.ShowError("Could not load the terrain for this TSA.", ex);
            }
        }
        void Core_LoadTerrainValues()
        {
            ...
            {
                Program.ShowError("There has been an error trying to load the terrain values.", ex);
            }
        ...
        private void Tileset_GridBox_SelectionChanged(Object sender, EventArgs e)
        {
            ...
            {
                Program.ShowError("There has been an error while trying to write the terrain map", ex);
            }
        }
