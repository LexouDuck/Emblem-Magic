namespace EmblemMagic.Editors
{
    partial class WorldMapEditor_FE8
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Mini_Map_TilesetPointerBox = new EmblemMagic.Components.PointerBox();
            this.Mini_Map_PaletteBox = new EmblemMagic.Components.PaletteBox();
            this.Mini_Map_PalettePointerBox = new EmblemMagic.Components.PointerBox();
            ...
            this.LargeMap_TilesetPointerBox = new EmblemMagic.Components.PointerBox();
            this.LargeMap_TSAPointerBox = new EmblemMagic.Components.PointerBox();
            ...
            this.SmallMap_TilesetPointerBox = new EmblemMagic.Components.PointerBox();
            this.SmallMap_PaletteBox = new EmblemMagic.Components.PaletteBox();
            this.SmallMap_TSAPointerBox = new EmblemMagic.Components.PointerBox();
            ...
            this.Mini_Map_ImageBox = new EmblemMagic.Components.ImageBox();
        ...
        private Components.PointerBox LargeMap_TilesetPointerBox;
        private Components.PointerBox LargeMap_TSAPointerBox;
        ...
        private Components.PointerBox Mini_Map_TilesetPointerBox;
        private Components.PaletteBox Mini_Map_PaletteBox;
        private Components.PointerBox Mini_Map_PalettePointerBox;
