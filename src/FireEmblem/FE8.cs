...
{
    public class FE8 : Game
    {
        public FE8(GameVersion version, bool clean, bool expanded) : base(version, clean, expanded) { }
        
        public static string GameID(GameVersion version)
        {
            switch (version)
            {
                case GameVersion.JAP: return "FIREEMBLEM8" + '\u0000' + "BE8J01";
                case GameVersion.USA: return "FIREEMBLEM2EBE8E01";
                case GameVersion.EUR: return "FIREEMBLEM2PBE8P01";
        ...
        public static uint Checksum(GameVersion version)
        {
            switch (version)
            {
                case GameVersion.JAP: return 0x9D76826F;
                case GameVersion.USA: return 0xA47246AE;
                case GameVersion.EUR: return 0xB3005195;
        ...
        public static uint DefaultFileSize(GameVersion version)
        {
            switch (version)
            {
                ...
                case GameVersion.EUR: return 0x02000000;
                default: throw new Exception("Invalid game version.");
            }
        }
        ...
        override public Range[] GetDefaultFreeSpace()
        {
            switch (Version)
            {
                case GameVersion.JAP: return new Range[]
                    {
                        new Range(0xBC3A00, 0xC00000),
                        new Range(0xE47200, 0xEE0000),
                        new Range(0xEF3000, 0xEF8000),
                        new Range(0xEFB300, 0xFE0000),
                        new Range(0xFE4000, 0xFFF000)
                    };
                case GameVersion.USA: return new Range[]
                    {
                        new Range(0xB2A610, 0xC00000),
                        new Range(0xE47200, 0xEE0000),
                        new Range(0xEF3000, 0xEF8000),
                        new Range(0xEFB000, 0xFDFD00),
                        new Range(0xFE4000, 0xFFF000)
                    };
                case GameVersion.EUR: return new Range[]
                    {
                        new Range(0x1147000, 0x1FE0000),
                        new Range(0x1FE3800, 0x1FFFF00)
                    };
                default: throw new Exception("Invalid game version.");
            }
        }
