    ...
    public class TrackerGrid : DataGridView
    {
        ...
        void ColumnHeaderMouseClicked(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (Volumes[e.ColumnIndex].Visible)
            {
                ...
                Columns[e.ColumnIndex].DefaultCellStyle.BackColor = Color.LightGray;
                Columns[e.ColumnIndex].DefaultCellStyle.ForeColor = Color.DarkGray;
            }
            else
            {
                ...
                Columns[e.ColumnIndex].DefaultCellStyle.BackColor = Color.White;
                Columns[e.ColumnIndex].DefaultCellStyle.ForeColor = Color.Black;
            }
        }
